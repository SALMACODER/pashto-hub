...
//   return (
//     <section className="relative overflow-hidden bg-gradient-to-br from-sand-50 via-white to-sand-100 dark:from-gray-950 dark:via-gray-900 dark:to-primary-950">
//       {/* Decorative pattern */}
//       <div className="absolute inset-0 bg-hero-pattern opacity-70" aria-hidden="true" />

//       {/* Floating ornaments */}
//       <div className="absolute rounded-full top-20 left-10 w-72 h-72 bg-primary-300/30 dark:bg-primary-700/20 blur-3xl animate-float" />
//       <div className="absolute rounded-full bottom-10 right-10 w-80 h-80 bg-gold-300/30 dark:bg-gold-700/20 blur-3xl animate-float" style={{ animationDelay: '2s' }} />
//       <div className="absolute rounded-full top-1/2 left-1/3 w-60 h-60 bg-crimson-500/10 blur-3xl" />
...
//             <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold-100 dark:bg-gold-900/40 text-gold-700 dark:text-gold-300 text-sm font-semibold mb-6">
//               <span className="w-2 h-2 rounded-full bg-gold-500 animate-pulse" />
//               {t('hero.badge')}
//             </span>

//             <h1 className="mb-6 text-4xl font-bold leading-tight text-gray-900 font-display sm:text-5xl lg:text-6xl dark:text-white">
//               {language === 'en' ? (
//                 <>
...
//             <p className={`text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0 ${language === 'ps' ? 'pashto-text' : ''}`}>
//               {t('hero.subtitle')}
//             </p>
...
//               <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary-500 via-gold-500 to-crimson-500 opacity-20 dark:opacity-30 blur-2xl" />
//             </div>
//           </div>
//         </div>
//       </div>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8 md:py-28">
        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          {/* Visual side — mountain already visible in background */}
          {/* <div className="relative items-center justify-center hidden lg:flex animate-slide-up">
            <div className="relative overflow-hidden border shadow-2xl w-80 h-80 rounded-3xl border-white/30 dark:border-gray-700/50"> */}
              {/* <img
                src={mountainImg}
                alt="Pashto landscape"
                className="object-cover w-full h-full"
              /> */}
              {/* Caption overlay */}
              {/* <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/70 to-transparent">
                <p className="text-lg font-bold text-center text-white pashto-text">
                  د پښتو خاوره
                </p>
